...
function iconSvg(rounded: boolean): string {
  ...
  <rect width="512" height="512" rx="${radius}" fill="#1d1b16"/>
  <path d="M348 176 A104 104 0 1 0 348 336" fill="none" stroke="#0f8b8d" stroke-width="40" stroke-linecap="round"/>
  <circle cx="366" cy="256" r="26" fill="#f5f2ec"/>
</svg>`;
}
